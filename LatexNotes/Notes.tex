...
\end{equation}
where $M$ is an integer (on the order of 10 or so). Notice that Johnson's formulation already incorporates the correct scaling of $\sqrt{d}$ to define $\xi$, which will make things convenient.
