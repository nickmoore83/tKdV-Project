...
The KdV equation in dimensional form is
\begin{equation}
2 \eta_t + \frac{3 c}{h_0} \eta \eta_{\xi} + \frac{c h_0^2}{3} \eta_{\xi \xi \xi} = 0
\end{equation}
Here, $\eta$ has units of length, $t$ time, $c = \sqrt{g h_0}$ is the wave speed, and $\xi = x - ct$. I obtained this equation by starting from Johnson's dimensionless equation (3.28) on page 208 and working backwards to untangle the scales that he had used to non-dimensionalize.
