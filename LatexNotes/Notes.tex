...
\begin{equation}
s = \frac{2 \pi \beta}{\lambda_0} \bar{x} = 2 \pi \beta \delta \eps^{-3/2} X
\end{equation}
...
\begin{equation}
\label{varKdVugly}
2 \beta H_s + \frac{3 \eps}{M} D^{-7/4} H H_\zeta
+ \frac{4 \pi^2 \delta^2}{3 M^3} D^{1/2} H_{\zeta \zeta \zeta} = 0
\end{equation}
...
\begin{align}
2 \beta u_s + \frac{3 \eps}{M} D^{-7/4} \, u u_x
+ \frac{4 \pi^2 \delta^2}{3 M^3} D^{1/2} \, u_{xxx} = 0
\end{align}
The definition of each of these dimensionless variables in terms of the original, physical ones are
\begin{align}
& u = D^{1/4} \, \bar{\eta}/a \\
& x = 2\pi \lambda_c^{-1} (\bar{x} - c \bar{t})  \\
& s = 2 \pi \beta \lambda_0^{-1} \bar{x}
\end{align}
