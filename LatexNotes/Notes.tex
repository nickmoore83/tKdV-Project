...
\end{equation}
Here, $\eta$ has units of length, $t$ time, $c = \sqrt{g h_0}$ is the wave speed, and $\xi = x - ct$. I obtained this equation by starting from Johnson's dimensionless equation ()
