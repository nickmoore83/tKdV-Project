...
\todo[inline]{If you are interested, we could cite papers on `Optical rogue waves' and/or rogue waves in microwave systems here.}
...
\todo[inline]{I am not sure we need to include this last item. It is not really an experimental observation, simply a calculation that can be done using the dispersion relation and the two depths. Could we simply take this last item out?}
