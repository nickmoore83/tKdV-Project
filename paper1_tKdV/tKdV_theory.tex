...
is a leading-order approximation of surface waves that are determined
...
domain $x\in\left[-\pi,\pi\right]$. The depth is assumed to be unit $D_{-}=1$ before the ADC and becomes $D_{+}<1$ after the ADC. 
The conserved Hamiltonian can be decomposed into a cubic and a quadratic term
\begin{align*}
