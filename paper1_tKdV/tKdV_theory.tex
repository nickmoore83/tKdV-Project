...
and $\gamma=\frac{U}{a}$ normalizes the total
energy of the state variable $u_{\Lambda}$ to one.
\todo[inline]{What is the variable $U$? Have we defined it?}
...
\todo[inline]{I do not quite understand the above sentence.}
