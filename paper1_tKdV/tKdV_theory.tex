...
\todo[inline]{If you like, we could cite papers on `Optical rogue waves' and/or rogue waves in microwave systems here.}
...
\todo[inline]{I modified the last sentence above. Feel free to revert to your original sentence if you do not like mine.}
...
\todo[inline]{Is there a difference between $L_0$ and $L_d$? typo?}
...
\todo[inline]{In this section title, did you mean `statistical mechanism' or `statistical mechanics'?}
...
\]
\todo[inline]{I do not believe we have defined $\mu_{\infty}^{-}$ anywhere.}
...
confirm each other.
\todo[inline]{Again, do we mean statistical `mechanism' or `mechanics'?}
