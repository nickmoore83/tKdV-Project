...
We will essential use the original normalization in \eqref{dimlessKdV1}, except with the slight modification that $\eta = \sqrt{\pi} \amp u$, so that the energy of $u$ is normalized to unity. This choice will be consistent with our PNAS paper and the J Stat Phys paper of Majda and Qi.
