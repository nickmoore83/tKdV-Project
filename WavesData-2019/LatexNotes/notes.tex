...
Position $x$ has been scaled on the upstream characteristic wavelength $\lambda_0 = \sqrt{g h_0}/f_p$. As a consequence of the scaling for displacement, we have fixed energy
\begin{equation}
\frac{1}{2} \intt u^2 \dx = \frac{1}{2}
\end{equation}

In \eqref{ndKdV} , $\lamfac$ is the number of peak wavelengths in the periodic domain (perhaps we should set $\lamfac=1$, see note below).
