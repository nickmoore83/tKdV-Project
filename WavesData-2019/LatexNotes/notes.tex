...
\begin{equation}
\label{dimlessKdV1}
u_t + \frac{3}{2} \pi \epsup \drat^{-1} \, u u_x + \frac{1}{6} \pi^3 \lamfac^{-2} \delup^2 \drat \, u_{xxx} = 0
...
Therefore, lets stick with the original normalization \eqref{dimlessKdV1}, repeated here
\begin{equation}
\label{dimlessKdV2}
u_t + \frac{3}{2} \pi \epsup \drat^{-1} \, u u_x + \frac{1}{6} \pi^3 \lamfac^{-2} \delup^2 \drat \, u_{xxx} = 0
\qquad \text{for } x \in [-\pi,\pi]
...
We now consider the Hamiltonian structure of the dimensionless variable-depth KdV equation \eqref{dimlessKdV1}, over dimensionless domain $x \in [-\pi,\pi]$. First, the spatial average of any quantity is given by
\begin{equation}
