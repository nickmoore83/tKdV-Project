...
or
\begin{equation}
\meanp{H_3} = \frac{\mu D_0^{2}}{\ampp} \left( \meanp{H_2} - \meanm{H_2} \right)
\end{equation}

Converting to dimensional (i.e.~experimental) values gives
\begin{equation}
\frac{\text{skew}(\eta)}{\Delta \mean{\eta_x^2}} =
\frac{3 \mu h_0^2 f_p^2 D_0^2 \lambda^2}{g a^3}
\end{equation}
