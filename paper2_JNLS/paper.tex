...
\caption{(a) Experimental schematic. (b)--(c) Surface displacement measured at a representative upstream and downstream location. (d)--(e) Corresponding histograms. Reproduced from \cite{bolles2019anomalous}}
\label{fig1}
\end{center}
\end{figure}
 %^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^%
