...
In Section \ref{experiments} we detail the laboratory experiments of \boetal~and summarize previously reported findings on anomalous statistics of the surface displacement. In this section, we also present new experimental data on surface {\em slope} statistics --- a line of inquiry motivated by the appearance of the slope in the Hamiltonian structure of TKdV theory developed by \maetal~\cite{majda2019}.
