...
\begin{figure}%[!ht]
\begin{center}
\includegraphics[width = 0.80 \linewidth]{FigsJPG/ExpDiagStats.jpg}
\caption{
...
\begin{figure}%[!ht]
\begin{center}
\includegraphics[width = 0.8 \linewidth]{FigsJPG/ExpSpatialStats.jpg}
...
\begin{figure}%[!ht]
\begin{center}
\includegraphics[width = 0.99 \linewidth]{FigsJPG/transfig.jpg}
\caption{
...
\begin{figure}%[!ht]
\begin{center}
\includegraphics[width = 0.99 \linewidth]{FigsJPG/uhist.jpg}
\caption{ 
...
\begin{figure}%[!ht]
\begin{center}
\includegraphics[width = 0.99 \linewidth]{FigsJPG/slopehist.jpg}
\caption{
...
\begin{figure}%[!ht]
\begin{center}
\includegraphics[width = 0.9 \linewidth]{FigsJPG/trajectories.jpg}
\caption{
...
\begin{figure}%[!ht]
\begin{center}
\includegraphics[width = 0.99 \linewidth]{FigsJPG/skew-kurt.jpg}
\caption{
...
\begin{figure}%[!ht]
\begin{center}
\includegraphics[width = 0.99 \linewidth]{FigsJPG/SkewRat.jpg}
\caption{
...
C.T.B. acknowledges support from the IDEA grant at Florida State University, as well as from the Geophysical Fluid Dynamics Institute. 
M.N.J.M. acknowledges support from the Simons Foundation, award 524259. 
