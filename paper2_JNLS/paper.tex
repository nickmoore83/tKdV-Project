...
\subsection{Statistical comparison between theory and experiments}
	...
	In Fig.~\ref{uhist} we show the displacement distributions that were measured in the experiments (top row) versus those that emerge from a mixed long-time/ensemble average of the TKdV simulations (bottom row). 	
	\vsp{5}
