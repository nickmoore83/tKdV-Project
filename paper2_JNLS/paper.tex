...
\vsp{5}
\section{Results}
Plot of transfer function for different lambdas. Shows that the transfer function is relatively insensitive to truncation index, as long as N scales appropriately.
