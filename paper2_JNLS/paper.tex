...
\caption{
Comparison of slope histograms. The TKdV simulations show similar slope distributions upstream, but visual distributions in the downstream distributions are visible. 
While the simulations recover the spread of the downstream slope statistics, they do not capture the asymmetry seen in the experiments \nick{to changes}.
}
\label{slopehist}
\end{center}
\end{figure}
