...
\begin{figure}%[!ht]
\begin{center}
\includegraphics[width = 0.99 \linewidth]{Figs/uhist_expsim.pdf}
\caption{
Amazing!
}
\label{hist_expsim}
...
Therefore, in Fig.~\ref{slopehist}, we convert the theoretical calculated values of $\partial u/\partial \tilde{x}$ to physical slope via
\begin{equation}
\pd{\eta}{x} = \frac{\ampscale \lamfac}{\lengthscale} \pd{u}{\tilde{x}}
\end{equation}
